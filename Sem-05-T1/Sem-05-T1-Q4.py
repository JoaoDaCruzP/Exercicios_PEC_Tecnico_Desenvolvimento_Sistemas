...
def main():
    print('Vamos converter minutos em horas?')
    print('Obs: Use somente numeros inteiros!\n')
    entrada_minutos = int(input('Digite a quantidade de minutos desejada: '))
    
    resultado_horas = converte_horas(entrada_minutos)
    resultado_minutos = converte_minutos(entrada_minutos)
    
    print(f'Apos a conversão o resultado é: {resultado_horas}H:{resultado_minutos}M') 
