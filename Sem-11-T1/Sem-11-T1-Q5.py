'''
    05. Pedro recebe um salário mensal e tem aumentos salariais de 5% uma vez por ano no mês de março. Pedro
        ...
        da dívida e calcula, simulando a evolução do salário e da dívid de Pedaro, em que mês e ano a dívida com
...
def main():
    ...
    print(f'O valor da divida irá superar o valor do salario em: {mes}/{ano}')
