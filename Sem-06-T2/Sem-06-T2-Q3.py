...
def main():
    print('VAMOS CALCULAR O VALOR TOTAL DA SUA COMPRA\n')
    #preciso saber qual o preço das frutas
    entrada_preco_maca = float(input('Digite o valor da unidade da maçã: ').strip())
    entrada_preco_banana = float(input('Digite  o valor da unidade da banana: ').strip())
