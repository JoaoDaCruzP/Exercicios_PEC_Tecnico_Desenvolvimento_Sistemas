...
def verifica_numero(n1):
    #primeiro verifica se o numero digitado é menor que mil
    if n1 > 999:
        raise ValueError('digite um numero menor que 1 mil(1000)')
    
    #divide o numero digitado em 3 partes
    else:
        centena = n1 // 100
        dezena = (n1 % 100) // 10
        unidade = n1 % 10
...
def main():
    ...
    i_num1 = int(input('Digite um numero entre 1 e 999: '))
    
    centena,dezena,unidade = verifica_numero(i_num1)

    #inicia as variaveis de formatação

    f_centena = ''
    f_dezena = ''
    f_unidade = ''

    #verifica o singular e o plural da centena
    if centena == 1:
    ...
    #verifica o singular e o plural da dezena
    if dezena == 1:
        f_dezena = 'uma dezena'
    elif dezena == 2:
    ...
    #verifica o singular e o plural da unidade
    if unidade == 1:
    ...
    #contador usado para saber quantos blocos vão aparecer(ex.: dezena e unidade = 2 blocos; so unidade = 1 bloco; etc...)
    contador = 0
    if centena != 0:
        contador +=1
    if dezena != 0:
    ...
    #analisa quais blocos irão aparecer no print no caso de dois blocos aparecer
    ...
    #analisa qual bloco irá aparecer no print no caso de apenas um bloco aparecer
